...
#     return img
#
# def SAM(img_cur, axs_cur, path_to_model):
#     # Подготовка модели SAM
...
#     model = torch.load(path_to_model + "seem_focalt_v2.pt", map_location=torch.device('cpu'))
#     masks_cur = model(img_cur)
#     # model.model.evaluate_referring_image
#     axs_cur.imshow(img_cur)
#     axs_cur.imshow(show_anns(masks_cur, axs_cur))
#
